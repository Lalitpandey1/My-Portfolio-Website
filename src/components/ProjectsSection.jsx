...
const projects = [
  {
    id: 1,
    title: "EnergizeX : Health supplement Aggregator",
    description:
      "A Full-featured e-commerce platform with user authentication and payment processing, scalable application Health Supplement Aggregator",
    image: img1,
    tags: [
      "React",
      "TailwindCSS",
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/Lalitpandey1"
          >
